...
\author                 {Mark Stanis{\l}aw Baranowski}
%\title                  {INTEGRAL ESTIMATION IN QUANTUM PHYSICS}

%\title{SMT-Based Formal Analysis of Safety-Critical Rust Programs and Libraries}

 \title{Supporting Multiple Languages in \\ Automated Reasoning}
...
\department             {Kahlert School of Computer Science}
...
\firstreader            {Matt Flatt}
\secondreader           {Mary W. Hall}
\thirdreader            {Pavel Panchekha}
\fourthreader           {Zvonimir Rakamari\'c}
...
\chairdateapproved      {01/13/2025}
\firstdateapproved      {01/07/2025}
\seconddateapproved     {01/13/2025}
\thirddateapproved      {01/08/2025}
\fourthdateapproved     {}
